    ...
    <div className="container mx-auto py-8 px-4">
      <Card className="mb-6">
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <h3 className="font-medium">
              Select Activities to Include in Training
            </h3>
              ...
              {isTraining ? (
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground text-center mt-2">
                    Training model with {selectedActivities.length}{" "}
                    activities...
                  </p>
                </div>
              ) : (
        ...
        <CardFooter className="text-sm text-muted-foreground">
          <p>
            Training a model requires collected data for at least two different
            activities. The more data available, the better the model
            performance will be.
          </p>
        </CardFooter>
      </Card>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                During training, the system processes your collected sensor data
                to learn patterns that distinguish different activities. The
                model analyzes accelerometer and gyroscope readings to identify
                unique characteristics of each activity.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                ...
                <li>
                  Ensure consistent sensor placement during data collection
                </li>
                <li>Collect data in various environments and conditions</li>
                <li>
                  Include transitions between activities in your training data
                </li>
              </ul>
            </div>
          </div>
