...
const ActivityPrediction = () => {
  ...
  const [predictedActivity, setPredictedActivity] = useState<string | null>(
    null,
  );
    ...
    <div className="container mx-auto py-8 px-4">
                  ...
                  <>
                    <div className="mb-2 flex justify-center">
                      <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center text-primary">
                        {activityIcons[predictedActivity] || (
                          <Activity className="h-12 w-12" />
                        )}
                      </div>
                    </div>
                    <h2 className="text-3xl font-bold text-primary">
                      {predictedActivity.charAt(0).toUpperCase() +
                        predictedActivity.slice(1)}
                    </h2>
                    <p className="mt-1">
                      Confidence:{" "}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Real-time data from accelerometer and gyroscope
          </CardDescription>
        </CardHeader>
        <CardContent>
          {sensorData.length > 0 ? (
