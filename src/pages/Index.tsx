      ...
      <header className="bg-gradient-to-b from-background to-muted/40">
        ...
        <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center">
          ...
          <p className="text-xl mb-10 max-w-2xl text-muted-foreground">
            Collect, analyze, and predict human activities using accelerometer
            and gyroscope data from ESP32 devices.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" asChild>
              <Link to={isAuthenticated ? "/collect" : "/login"}>Try Demo</Link>
            </Button>
          </div>
        </div>
      </header>
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-muted-foreground">
            Join MotionSense today and start exploring the possibilities of
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-muted-foreground text-sm">
              &copy; {new Date().getFullYear()} MotionSense. All rights
              reserved.
            </p>
          </div>
        </div>
